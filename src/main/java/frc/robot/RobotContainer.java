...
public class RobotContainer {
  ...
  public RobotContainer() {
    ...
    NamedCommands
        .registerCommand( // This command keeps the robot from scoring unless the elevator is at the
            // correct positition
            "AScore", Commands.idle().until(m_elevator.isAtPosition()));
