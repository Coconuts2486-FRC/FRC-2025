...
// import frc.robot.subsystems.superstructure.SuperstructurePose.DispenserPose;
...
//                         () ->
//                             Superstructure.getScoringState(
//                                 coralObjective.get().reefLevel(), superstructure.hasAlgae(),
// true))
//                     .withTimeout(0.2)),
...
//     return getBranchPose(coralObjective) // Use dispenser pose relative to branch to find robot
// pose
//         .transformBy(
//             GeomUtil.toTransform2d(
...
//         .toPose2d()
//         .interpolate(
//             Reef.branchPositions.get(branchId + 1).get(FieldConstants.ReefLevel.L3).toPose2d(),
// 0.5)
//         .transformBy(
//             GeomUtil.toTransform2d(
//                 dispenserPose.getElevatorHeight() *
...
//   /**
//    * Get robot pose based on how far away from associated tag we are. Uses 2d estimation data
// when
//    * close.
//    */
