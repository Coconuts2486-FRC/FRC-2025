...
public class LEDSubsystem extends SubsystemBase {
  ...
  public final SingleFadeAnimation blueFade,
      redFade,
      yellowFade,
      whiteFade,
      yellowFadeFast,
  ...
  public LEDSubsystem() {
    ...
    blueRightFlow =
        colorFlow(BLUE, 0.7, Direction.Backward, STRIP_2_LENGTH, NO_CANDLE_OFFSET + STRIP_LENGTH);
  ...
  public SingleFadeAnimation fade(LEDColor color, double speed) {
    return new SingleFadeAnimation(
        color.r, color.g, color.b, color.w, speed, NUM_LEDS, STRIP_OFFSET);
  }

  public TwinkleAnimation twinkle(LEDColor color, double speed, TwinklePercent percent) {
    return new TwinkleAnimation(
        color.r, color.g, color.b, color.w, speed, NUM_LEDS, percent, STRIP_OFFSET);
  }
  ...
  public ColorFlowAnimation colorFlow(
      LEDColor color, double speed, Direction direction, int numLeds, int ledOffset) {
    return new ColorFlowAnimation(
        color.r, color.g, color.b, color.w, speed, numLeds, direction, ledOffset);
  }
