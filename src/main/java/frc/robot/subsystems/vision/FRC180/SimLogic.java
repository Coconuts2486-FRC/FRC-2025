...
public abstract class SimLogic {
  ...
  public static void spawnHumanPlayerCoral(boolean blue) {
    ...
    for (int i = 0; i < 2; i++) {
      ...
      Transform2d randomTransform =
          new Transform2d(xOffset, yOffset, Rotation2d.fromDegrees(rotationOffset));
  ...
  public static void scoreCoral() {
    ...
    double xOffset;
    Distance coralHeight = Meters.of(0. + heightOffset);
  ...
  public static void netAlgae(boolean forwards) {
    ...
    //             simRobotPose
    //                 .getRotation()
    //                 .rotateBy(forwards ? Rotation2d.kZero : Rotation2d.k180deg),
    //             Meters.of(10.), // outtake height
