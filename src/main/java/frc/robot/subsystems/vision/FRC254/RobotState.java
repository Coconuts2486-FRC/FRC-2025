...
// ConcurrentTimeInterpolatableBuffer
//             .createBuffer(LOOKBACK_TIME);
//     private static final Transform2d TURRET_TO_CAMERA = new
// Transform2d(Constants.kTurretToCameraX,
//             Constants.kTurretToCameraY,
//             MathHelpers.kRotation2dZero);
//     private static final Transform2d ROBOT_TO_CAMERA_B = new
// Transform2d(Constants.kTurretToCameraBX,
//             Constants.kTurretToCameraBY,
//             MathHelpers.kRotation2dZero);
//     private final AtomicReference<ChassisSpeeds> measuredRobotRelativeChassisSpeeds = new
// AtomicReference<>(
//             new ChassisSpeeds());
//     private final AtomicReference<ChassisSpeeds> measuredFieldRelativeChassisSpeeds = new
// AtomicReference<>(
//             new ChassisSpeeds());
//     private final AtomicReference<ChassisSpeeds> desiredFieldRelativeChassisSpeeds = new
// AtomicReference<>(
//             new ChassisSpeeds());
//     private final AtomicReference<ChassisSpeeds> fusedFieldRelativeChassisSpeeds = new
// AtomicReference<>(
//             new ChassisSpeeds());
...
//         Pose2d fieldToRobot = maybeFieldToRobot == null ? MathHelpers.kPose2dZero :
// maybeFieldToRobot.getValue();
//         var delta = getLatestRobotRelativeChassisSpeed();
//         delta = delta.times(lookaheadTimeS);
//         return fieldToRobot
//                 .exp(new Twist2d(delta.vxMetersPerSecond, delta.vyMetersPerSecond,
...
//     private Optional<Double> getMaxAbsValueInRange(ConcurrentTimeInterpolatableBuffer<Double>
// buffer, double minTime,
//             double maxTime) {
...
//     public Optional<Double> getMaxAbsTurretYawAngularVelocityInRange(double minTime, double
// maxTime) {
//         return getMaxAbsValueInRange(turretAngularVelocity, minTime, maxTime);
//     }

//     public Optional<Double> getMaxAbsDriveYawAngularVelocityInRange(double minTime, double
// maxTime) {
...
//     public Optional<Double> getMaxAbsDrivePitchAngularVelocityInRange(double minTime, double
// maxTime) {
//         return getMaxAbsValueInRange(drivePitchAngularVelocity, minTime, maxTime);
//     }

//     public Optional<Double> getMaxAbsDriveRollAngularVelocityInRange(double minTime, double
// maxTime) {
...
//             Logger.recordOutput("RobotState/AccelX",
// this.accelX.getInternalBuffer().lastEntry().getValue());
//         }
//         if (this.accelY.getInternalBuffer().lastEntry() != null) {
//             Logger.recordOutput("RobotState/AccelY",
// this.accelY.getInternalBuffer().lastEntry().getValue());
//         }
//         Logger.recordOutput("RobotState/DesiredChassisSpeedFieldFrame",
// getLatestDesiredFieldRelativeChassisSpeed());
//         Logger.recordOutput("RobotState/MeasuredChassisSpeedFieldFrame",
// getLatestMeasuredFieldRelativeChassisSpeeds());
//         Logger.recordOutput("RobotState/FusedChassisSpeedFieldFrame",
